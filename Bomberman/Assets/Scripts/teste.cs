...
public class teste : MonoBehaviour {
    ...
    {		
		...
		RaycastHit2D facing = Physics2D.Raycast (facingRayInitial, rayDirection[randomIndex], 0.3f, checkthis);
	...
	Collider2D Raycasting(int index){
		RaycastHit2D hit = Physics2D.Raycast (transform.position, rayDirection[index], 1f, checkthis);
		return hit.collider;
	}
